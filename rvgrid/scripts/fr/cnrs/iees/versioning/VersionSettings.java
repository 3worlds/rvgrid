...
public class VersionSettings {
	...
	protected static String ORG = "fr.cnrs.iees.rvgrid";
	
	/** The name of the ivy module (this will be the name of the generated jar file for 
	 * dependent projects).*/
	protected static String MODULE = "rvgrid";
	...
	protected static String DESCRIPTION = 
		"A light-weight implementation of ADA's rendez-vous messaging pattern";
